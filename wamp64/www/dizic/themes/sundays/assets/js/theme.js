! function(e) {
    ...
    u.default.responsive = u.default.responsive || {}, u.default.responsive.current_width = (0, s.default)(window).width(), u.default.responsive.min_width = 768, u.default.responsive.mobile = u.default.responsive.current_width < u.default.responsive.min_width, (0, s.default)(window).on("resize", function() {
        var e = u.default.responsive.current_width,
            ...
            i = e >= t && n < t || e < t && n >= t;
        u.default.responsive.mobile = e >= t, u.default.responsive.current_width = n, i && o()
    ...
    function r() {
        0 !== (0, a.default)(".js-cancel-address").length && (0, a.default)(".checkout-step:not(.js-current-step) .step-title").addClass("not-allowed"), (0, a.default)(".js-terms a").on("click", function(e) {
            ...
            t && (t += "?content_only=1", a.default.get(t, function(e) {
                (0, a.default)("#modal").find(".modal-content").html((0, a.default)(e).find(".page-cms").contents())
            }).fail(function(e) {
    ...
    var i, r; /*! VelocityJS.org (1.4.2). (C) 2014 Julian Shapiro. MIT @license: en.wikipedia.org/wiki/MIT_License */
    ...
    function(o) {
        ...
        return function(e, t, n, i) {
            ...
            function f(e, t) {
                var n = e;
                return b.isString(e) ? S.Easings[e] || (n = !1) : n = b.isArray(e) && 1 === e.length ? u.apply(null, e) : b.isArray(e) && 2 === e.length ? E.apply(null, e.concat([t])) : !(!b.isArray(e) || 4 !== e.length) && c.apply(null, e), n === !1 && (n = S.Easings[S.defaults.easing] ? S.defaults.easing : w), n
            }
                    ...
                    for (var o = 0; o < n; o++)
                        if (S.State.calls[o]) {
                            var s = S.State.calls[o],
                                ...
                                y = s[5],
                                _ = s[6];
                            if (c || (c = S.State.calls[o][3] = t - 16), y) {
                                if (y.resume !== !0) continue;
                                c = s[3] = Math.round(t - _ - 16), s[5] = null
                            }
                            _ = s[6] = t - c;
                            for (var x = Math.min(_ / u.duration, 1), w = 0, E = l.length; w < E; w++) {
                                var T = l[w],
                                    k = T.element;
                                if (a(k)) {
                                    var O = !1;
                                    if (u.display !== i && null !== u.display && "none" !== u.display) {
                                        if ("flex" === u.display) {
                                            ...
                                            p.each(I, function(e, t) {
                                                C.setPropertyValue(k, "display", t)
                                            })
                                        }
                                        C.setPropertyValue(k, "display", u.display)
                                    }
                                    u.visibility !== i && "hidden" !== u.visibility && C.setPropertyValue(k, "visibility", u.visibility);
                                    for (var D in T)
                                        if (T.hasOwnProperty(D) && "element" !== D) {
                                            var N, P = T[D],
                                                L = b.isString(P.easing) ? S.Easings[P.easing] : P.easing;
                                            ...
                                            if (P.currentValue = N, "tween" === D) g = N;
                                                ...
                                                if (C.Hooks.registered[D]) {
                                                    V = C.Hooks.getRoot(D);
                                                    var F = a(k).rootPropertyValueCache[V];
                                                    F && (P.rootPropertyValue = F)
                                                }
                                                var R = C.setPropertyValue(k, D, P.currentValue + (m < 9 && 0 === parseFloat(N) ? "" : P.unitType), P.rootPropertyValue, P.scrollData);
                                                C.Hooks.registered[D] && (C.Normalizations.registered[V] ? a(k).rootPropertyValueCache[V] = C.Normalizations.registered[V]("extract", null, R[1]) : a(k).rootPropertyValueCache[V] = R[1]), "transform" === R[0] && (O = !0)
                                            }
                                        }
                                    u.mobileHA && a(k).transformCache.translate3d === i && (a(k).transformCache.translate3d = "(0px, 0px, 0px)", O = !0), O && C.flushTransformCache(k)
                                }
                            }
                            u.display !== i && "none" !== u.display && (S.State.calls[o][2].display = !1), u.visibility !== i && "hidden" !== u.visibility && (S.State.calls[o][2].visibility = !1), u.progress && u.progress.call(s[1], s[1], x, Math.max(0, c + u.duration - t), c, g), 1 === x && h(o)
                        }
                }
                S.State.isTicking && A(d)
            }

            function h(e, t) {
                if (!S.State.calls[e]) return !1;
                for (var n = S.State.calls[e][0], r = S.State.calls[e][1], o = S.State.calls[e][2], s = S.State.calls[e][4], l = !1, u = 0, c = n.length; u < c; u++) {
                    var f = n[u].element;
                    ...
                    if (o.loop !== !0 && (p.queue(f)[1] === i || !/\.velocityQueueEntryFlag/i.test(p.queue(f)[1])) && d) {
                        ...
                        }), o.mobileHA && (h = !0, delete d.transformCache.translate3d), h && C.flushTransformCache(f), C.Values.removeClass(f, "velocity-animating")
                    }
            ...
            var p, m = function() {
                ...
                v = function() {
                    ...
                    if (!Object.prototype.hasOwnProperty.call(e, "now")) {
                        var n = e.timing && e.timing.domComplete ? e.timing.domComplete : (new Date).getTime();
                        e.now = function() {
                ...
                _ = !1;
            if (e.fn && e.fn.jquery ? (p = e, _ = !0) : p = t.Velocity.Utilities, m <= 8 && !_) throw new Error("Velocity: IE8 and below require jQuery to be loaded before Velocity.");
            ...
            var x = 400,
                ...
                S = {
                    ...
                    pauseAll: function(e) {
                        ...
                        p.each(S.State.calls, function(t, n) {
                            if (n) {
                        ...
                        }), p.each(S.State.delayedElements, function(e, n) {
                            n && s(n, t)
                        })
                    },
            ...
            t.pageYOffset !== i ? (S.State.scrollAnchor = t, S.State.scrollPropertyLeft = "pageXOffset", S.State.scrollPropertyTop = "pageYOffset") : (S.State.scrollAnchor = n.documentElement || n.body.parentNode || n.body, S.State.scrollPropertyLeft = "scrollLeft", S.State.scrollPropertyTop = "scrollTop");
            var E = function() {
                function e(e) {
            ...
            S.Easings = {
                ...
                S.Easings[t[0]] = c.apply(null, t[1])
            });
            var C = S.CSS = {
                RegEx: {
                    isHex: /^#([A-f\d]{3}){1,2}$/i,
                ...
                Hooks: {
                    ...
                    fixColors: function(e) {
                        return e.replace(/(rgba?\(\s*)?(\b[a-z]+\b)/g, function(e, t, n) {
                            return C.Lists.colorNames.hasOwnProperty(n) ? (t ? t : "rgba(") + C.Lists.colorNames[n] + (t ? "" : ",1)") : t + n
                        })
                    },
                    ...
                    extractValue: function(e, t) {
                        ...
                        if (n) {
                            var i = n[0],
                                r = n[1];
                            return t = C.Hooks.cleanRootPropertyValue(i, t), t.toString().match(C.RegEx.valueSplit)[r]
                        }
                        return t
                    },
                    injectValue: function(e, t, n) {
                        ...
                        if (i) {
                            var r, o, a = i[0],
                                s = i[1];
                            return n = C.Hooks.cleanRootPropertyValue(a, n), r = n.toString().match(C.RegEx.valueSplit), r[s] = t, o = r.join(" ")
                        }
                        return n
                    }
                },
                Normalizations: {
                    ...
                    register: function() {
                        function e(e, t, n) {
                            var i = "border-box" === C.getPropertyValue(t, "boxSizing").toString().toLowerCase();
                            if (i === (n || !1)) {
                                var r, o, a = 0,
                                    s = "width" === e ? ["Left", "Right"] : ["Top", "Bottom"],
                                    l = ["padding" + s[0], "padding" + s[1], "border" + s[0] + "Width", "border" + s[1] + "Width"];
                                for (r = 0; r < l.length; r++) o = parseFloat(C.getPropertyValue(t, l[r])), isNaN(o) || (a += o);
                                return n ? -a : a
                            }
                            return 0
                        }
                        ...
                        m && !(m > 9) || S.State.isGingerbread || (C.Lists.transformsBase = C.Lists.transformsBase.concat(C.Lists.transforms3D));
                        for (var n = 0; n < C.Lists.transformsBase.length; n++) ! function() {
                            var e = C.Lists.transformsBase[n];
                            C.Normalizations.registered[e] = function(t, n, r) {
                                switch (t) {
                                    case "name":
                                        return "transform";
                                    case "extract":
                    ...
                    prefixCheck: function(e) {
                        ...
                        for (var t = ["", "Webkit", "Moz", "ms", "O"], n = 0, i = t.length; n < i; n++) {
                            ...
                            if (r = 0 === n ? e : t[n] + e.replace(/^\w/, function(e) {
                                ...
                                }), b.isString(S.State.prefixElement.style[r])) return S.State.prefixMatches[e] = r, [r, !0]
                        }
                        return [e, !1]
                    }
                },
                ...
                getPropertyValue: function(e, n, r, o) {
                    function s(e, n) {
                        ...
                        if (m <= 8) r = p.css(e, n);
                            ...
                            var l = !1;
                            /^(width|height)$/.test(n) && 0 === C.getPropertyValue(e, "display") && (l = !0, C.setPropertyValue(e, "display", C.Values.getDisplayType(e)));
                            var u = function() {
                                l && C.setPropertyValue(e, "display", "none")
                            };
                            if (!o) {
                                if ("height" === n && "border-box" !== C.getPropertyValue(e, "boxSizing").toString().toLowerCase()) {
                                    var c = e.offsetHeight - (parseFloat(C.getPropertyValue(e, "borderTopWidth")) || 0) - (parseFloat(C.getPropertyValue(e, "borderBottomWidth")) || 0) - (parseFloat(C.getPropertyValue(e, "paddingTop")) || 0) - (parseFloat(C.getPropertyValue(e, "paddingBottom")) || 0);
                                    return u(), c
                                }
                                if ("width" === n && "border-box" !== C.getPropertyValue(e, "boxSizing").toString().toLowerCase()) {
                                    var f = e.offsetWidth - (parseFloat(C.getPropertyValue(e, "borderLeftWidth")) || 0) - (parseFloat(C.getPropertyValue(e, "borderRightWidth")) || 0) - (parseFloat(C.getPropertyValue(e, "paddingLeft")) || 0) - (parseFloat(C.getPropertyValue(e, "paddingRight")) || 0);
                                    return u(), f
                                }
                            }
                            var d;
                    ...
                    if (C.Hooks.registered[n]) {
                        var u = n,
                            c = C.Hooks.getRoot(u);
                        r === i && (r = C.getPropertyValue(e, C.Names.prefixCheck(c)[0])), C.Normalizations.registered[c] && (r = C.Normalizations.registered[c]("extract", e, r)), l = C.Hooks.extractValue(u, r)
                    } else if (C.Normalizations.registered[n]) {
                        var f, d;
                        f = C.Normalizations.registered[n]("name", e), "transform" !== f && (d = s(e, C.Names.prefixCheck(f)[0]), C.Values.isCSSNullValue(d) && C.Hooks.templates[n] && (d = C.Hooks.templates[n][1])), l = C.Normalizations.registered[n]("extract", e, d)
                    }
                    if (!/^[\d-]/.test(l)) {
                        var h = a(e);
                        if (h && h.isSVG && C.Names.SVGAttribute(n))
                    ...
                    return C.Values.isCSSNullValue(l) && (l = 0), S.debug >= 2 && console.log("Get " + n + ": " + l), l
                },
                setPropertyValue: function(e, n, i, r, o) {
                    ...
                    else if (C.Normalizations.registered[n] && "transform" === C.Normalizations.registered[n]("name", e)) C.Normalizations.registered[n]("inject", e, i), s = "transform", i = a(e).transformCache[n];
                    else {
                        if (C.Hooks.registered[n]) {
                            var l = n,
                                u = C.Hooks.getRoot(n);
                            r = r || C.getPropertyValue(e, u), i = C.Hooks.injectValue(l, i, r), n = u
                        }
                        if (C.Normalizations.registered[n] && (i = C.Normalizations.registered[n]("inject", e, i), n = C.Normalizations.registered[n]("name", e)), s = C.Names.prefixCheck(n)[0], m <= 8) try {
                            e.style[s] = i
                        } catch (e) {
                            S.debug && console.log("Browser does not support [" + i + "] for [" + s + "]")
                        } else {
                            var c = a(e);
                            c && c.isSVG && C.Names.SVGAttribute(n) ? e.setAttribute(n, i) : e.style[s] = i
                        }
                ...
                flushTransformCache: function(e) {
                    var t = "",
                        n = a(e);
                    if ((m || S.State.isAndroid && !S.State.isChrome) && n && n.isSVG) {
                        var i = function(t) {
            ...
            C.Hooks.register(), C.Normalizations.register(), S.hook = function(e, t, n) {
                var r;
                return e = o(e), p.each(e, function(e, o) {
                    if (a(o) === i && S.init(o), n === i) r === i && (r = C.getPropertyValue(o, t));
                    else {
                        var s = C.setPropertyValue(o, t, n);
            ...
            var T = function() {
                ...
                function r(e, r) {
                    function o(o) {
                        ...
                        if ("scroll" === D) {
                            var m, g, x, w = /^x$/i.test(l.axis) ? "Left" : "Top",
                                T = parseFloat(l.offset) || 0;
                            l.container ? b.isWrapped(l.container) || b.isNode(l.container) ? (l.container = l.container[0] || l.container, m = l.container["scroll" + w], x = m + p(e).position()[w.toLowerCase()] + T) : l.container = null : (m = S.State.scrollAnchor[S.State["scrollProperty" + w]], g = S.State.scrollAnchor[S.State["scrollProperty" + ("Left" === w ? "Top" : "Left")]], x = p(e).offset()[w.toLowerCase()] + T), u = {
                                scroll: {
                                    rootPropertyValue: !1,
                                    startValue: m,
                                    currentValue: m,
                                ...
                                element: e
                            }, S.debug && console.log("tweensContainer (scroll): ", u.scroll, e)
                        } else if ("reverse" === D) {
                            if (c = a(e), !c) return;
                            if (!c.tweensContainer) return void p.dequeue(e, l.queue);
                            "none" === c.opts.display && (c.opts.display = "auto"), "hidden" === c.opts.visibility && (c.opts.visibility = "visible"), c.opts.loop = !1, c.opts.begin = null, c.opts.complete = null, _.easing || delete l.easing, _.duration || delete l.duration, l = p.extend({}, c.opts, l), h = p.extend(!0, {}, c ? c.tweensContainer : null);
                            for (var O in h)
                                if (h.hasOwnProperty(O) && "element" !== O) {
                                    var I = h[O].startValue;
                                    h[O].startValue = h[O].currentValue = h[O].endValue, h[O].endValue = I, b.isEmptyObject(_) || (h[O].easing = l.easing), S.debug && console.log("reverse tweensContainer (" + O + "): " + JSON.stringify(h[O]), e)
                                }
                            u = h
                        } else if ("start" === D) {
                            ...
                            var N = function(t, n) {
                                    var i, o, a;
                                    return b.isFunction(t) && (t = t.call(e, r, A)), b.isArray(t) ? (i = t[0], !b.isArray(t[1]) && /^[\d-]/.test(t[1]) || b.isFunction(t[1]) || C.RegEx.isHex.test(t[1]) ? a = t[1] : b.isString(t[1]) && !C.RegEx.isHex.test(t[1]) && S.Easings[t[1]] || b.isArray(t[1]) ? (o = n ? t[1] : f(t[1], l.duration), a = t[2]) : a = t[1] || t[2]) : i = t, n || (o = o || l.easing), b.isFunction(i) && (i = i.call(e, r, A)), b.isFunction(a) && (a = a.call(e, r, A)), [i || 0, o, a]
                                },
                                P = function(r, o) {
                                    var a, f = C.Hooks.getRoot(r),
                                        ...
                                        g = o[1],
                                        v = o[2];
                                    if (!(c && c.isSVG || "tween" === f || C.Names.prefixCheck(f)[1] !== !1 || C.Normalizations.registered[f] !== i)) return void(S.debug && console.log("Skipping [" + f + "] due to a lack of browser support."));
                                    (l.display !== i && null !== l.display && "none" !== l.display || l.visibility !== i && "hidden" !== l.visibility) && /opacity|filter/.test(r) && !v && 0 !== m && (v = 0), l._cacheValues && h && h[r] ? (v === i && (v = h[r].endValue + h[r].unitType), d = c.rootPropertyValueCache[f]) : C.Hooks.registered[r] ? v === i ? (d = C.getPropertyValue(e, f), v = C.getPropertyValue(e, r, d)) : d = C.Hooks.templates[f][1] : v === i && (v = C.getPropertyValue(e, r));
                                    var y, _, x, w = !1,
                                        E = function(e, t) {
                                            var n, i;
                                    ...
                                    if (v !== m && b.isString(v) && b.isString(m)) {
                                        ...
                                        for (v = C.Hooks.fixColors(v), m = C.Hooks.fixColors(m); T < v.length && A < m.length;) {
                                            ...
                                            if (/[\d\.]/.test(P) && /[\d\.]/.test(L)) {
                                                for (var j = P, B = L, F = ".", R = "."; ++T < v.length;) {
                                                    if (P = v[T], P === F) F = "..";
                                                ...
                                                var M = C.Hooks.getUnit(v, T),
                                                    H = C.Hooks.getUnit(m, A);
                                                if (T += M.length, A += H.length, M === H) j === B ? a += j + M : (a += "{" + k.length + (D ? "!" : "") + "}" + M, k.push(parseFloat(j)), O.push(parseFloat(B)));
                                                else {
                                                    var W = parseFloat(j),
                                                        U = parseFloat(B);
                                        ...
                                        T === v.length && A === m.length || (S.debug && console.error('Trying to pattern match mis-matched strings ["' + m + '", "' + v + '"]'), a = i), a && (k.length ? (S.debug && console.log('Pattern found "' + a + '" -> ', k, O, "[" + v + "," + m + "]"), v = k, m = O, _ = x = "") : a = i)
                                    }
                                    a || (y = E(r, v), v = y[0], x = y[1], y = E(r, m), m = y[0].replace(/^([+-\/*])=/, function(e, t) {
                                        return w = t, ""
                                    ...
                                    var q = function() {
                                        ...
                                        var a = 100,
                                            s = {};
                                        if (o && r) s.emToPx = V.lastEmToPx, s.percentToPxWidth = V.lastPercentToPxWidth, s.percentToPxHeight = V.lastPercentToPxHeight;
                                        else {
                                            var l = c && c.isSVG ? n.createElementNS("http://www.w3.org/2000/svg", "rect") : n.createElement("div");
                                            S.init(l), i.myParent.appendChild(l), p.each(["overflow", "overflowX", "overflowY"], function(e, t) {
                                                S.CSS.setPropertyValue(l, t, "hidden")
                                            }), S.CSS.setPropertyValue(l, "position", i.position), S.CSS.setPropertyValue(l, "fontSize", i.fontSize), S.CSS.setPropertyValue(l, "boxSizing", "content-box"), p.each(["minWidth", "maxWidth", "width", "minHeight", "maxHeight", "height"], function(e, t) {
                                                S.CSS.setPropertyValue(l, t, a + "%")
                                            }), S.CSS.setPropertyValue(l, "paddingLeft", a + "em"), s.percentToPxWidth = V.lastPercentToPxWidth = (parseFloat(C.getPropertyValue(l, "width", null, !0)) || 1) / a, s.percentToPxHeight = V.lastPercentToPxHeight = (parseFloat(C.getPropertyValue(l, "height", null, !0)) || 1) / a, s.emToPx = V.lastEmToPx = (parseFloat(C.getPropertyValue(l, "paddingLeft")) || 1) / a, i.myParent.removeChild(l)
                                        }
                                        return null === V.remToPx && (V.remToPx = parseFloat(C.getPropertyValue(n.body, "fontSize")) || 16), null === V.vwToPx && (V.vwToPx = parseFloat(t.innerWidth) / 100, V.vhToPx = parseFloat(t.innerHeight) / 100), s.remToPx = V.remToPx, s.vwToPx = V.vwToPx, s.vhToPx = V.vhToPx, S.debug >= 1 && console.log("Unit ratios: " + JSON.stringify(s), e), s
                                    };
                                    if (/[\/*]/.test(w)) _ = x;
                                    else if (x !== _ && 0 !== v)
                                        if (0 === m) _ = x;
                                    ...
                                    u[r] = {
                                        ...
                                        unitType: _,
                                        easing: g
                                    }, a && (u[r].pattern = a), S.debug && console.log("tweensContainer (" + r + "): " + JSON.stringify(u[r]), e)
                                };
                            for (var L in y)
                                if (y.hasOwnProperty(L)) {
                                    ...
                                    if (C.Lists.colors.indexOf(j) >= 0) {
                                        ...
                                        if (C.RegEx.isHex.test(R)) {
                                            for (var W = ["Red", "Green", "Blue"], U = C.Values.hexToRgb(R), q = H ? C.Values.hexToRgb(H) : i, z = 0; z < W.length; z++) {
                                                var $ = [U[z]];
                        ...
                        u.element && (C.Values.addClass(e, "velocity-animating"), F.push(u), c = a(e), c && ("" === l.queue && (c.tweensContainer = u, c.opts = l), c.isAnimating = !0), k === A - 1 ? (S.State.calls.push([F, v, l, null, E.resolver, null, 0]), S.State.isTicking === !1 && (S.State.isTicking = !0, d())) : k++)
                    }
                    var s, l = p.extend({}, S.defaults, _),
                        u = {};
                    switch (a(e) === i && S.init(e), parseFloat(l.delay) && l.queue !== !1 && p.queue(e, l.queue, function(t) {
                ...
                var u, c, m, g, v, y, _, w = arguments[0] && (arguments[0].p || p.isPlainObject(arguments[0].properties) && !arguments[0].properties.names || b.isString(arguments[0].properties));
                b.isWrapped(this) ? (c = !1, g = 0, v = this, m = this) : (c = !0, g = 1, v = w ? arguments[0].elements || arguments[0].e : arguments[0]);
                var E = {
                    promise: null,
                    resolver: null,
                    rejecter: null
                };
                if (c && S.Promise && (E.promise = new S.Promise(function(e, t) {
                        E.resolver = e, E.rejecter = t
                    })), w ? (y = arguments[0].properties || arguments[0].p, _ = arguments[0].options || arguments[0].o) : (y = arguments[g], _ = arguments[g + 1]), v = o(v), !v) return void(E.promise && (y && _ && _.promiseRejectEmpty === !1 ? E.resolver() : E.rejecter()));
                var A = v.length,
                    k = 0;
                if (!/^(stop|finish|finishAll|pause|resume)$/i.test(y) && !p.isPlainObject(_)) {
                    var O = g + 1;
                    _ = {};
                    for (var I = O; I < arguments.length; I++) b.isArray(arguments[I]) || !/^(fast|normal|slow)$/i.test(arguments[I]) && !/^\d/.test(arguments[I]) ? b.isString(arguments[I]) || b.isArray(arguments[I]) ? _.easing = arguments[I] : b.isFunction(arguments[I]) && (_.complete = arguments[I]) : _.duration = arguments[I]
                }
                var D;
                switch (y) {
                    case "scroll":
                    ...
                    case "pause":
                        ...
                        return p.each(v, function(e, t) {
                            s(t, N)
                        }), p.each(S.State.calls, function(e, t) {
                            var n = !1;
                            t && p.each(t[1], function(e, r) {
                                var o = _ === i ? "" : _;
                                return o !== !0 && t[2].queue !== o && (_ !== i || t[2].queue !== !1) || (p.each(v, function(e, i) {
                                    if (i === r) return t[5] = {
                                        resume: !1
                                    }, n = !0, !1
                                }), !n && void 0)
                    ...
                    case "resume":
                        return p.each(v, function(e, t) {
                            ...
                            t && p.each(t[1], function(e, r) {
                                var o = _ === i ? "" : _;
                                return o !== !0 && t[2].queue !== o && (_ !== i || t[2].queue !== !1) || (!t[5] || (p.each(v, function(e, i) {
                    ...
                    case "stop":
                        p.each(v, function(e, t) {
                            a(t) && a(t).delayTimer && (clearTimeout(a(t).delayTimer.setTimeout), a(t).delayTimer.next && a(t).delayTimer.next(), delete a(t).delayTimer), "finishAll" !== y || _ !== !0 && !b.isString(_) || (p.each(p.queue(t, b.isString(_) ? _ : ""), function(e, t) {
                                b.isFunction(t) && t()
                            }), p.queue(t, b.isString(_) ? _ : "", []))
                        });
                        var P = [];
                        return p.each(S.State.calls, function(e, t) {
                            t && p.each(t[1], function(n, r) {
                                var o = _ === i ? "" : _;
                                return o !== !0 && t[2].queue !== o && (_ !== i || t[2].queue !== !1) || void p.each(v, function(n, i) {
                                    if (i === r)
                                        if ((_ === !0 || b.isString(_)) && (p.each(p.queue(i, b.isString(_) ? _ : ""), function(e, t) {
                                                b.isFunction(t) && t(null, !0)
                                            }), p.queue(i, b.isString(_) ? _ : "", [])), "stop" === y) {
                                            var s = a(i);
                        ...
                        }), "stop" === y && (p.each(P, function(e, t) {
                            h(t, !0)
                        }), E.promise && E.resolver(v)), e();
                    default:
                        if (!p.isPlainObject(y) || b.isEmptyObject(y)) {
                            if (b.isString(y) && S.Redirects[y]) {
                                u = p.extend({}, _);
                                var L = u.duration,
                                    j = u.delay || 0;
                                return u.backwards === !0 && (v = p.extend(!0, [], v).reverse()), p.each(v, function(e, t) {
                                    parseFloat(u.stagger) ? u.delay = j + parseFloat(u.stagger) * e : b.isFunction(u.stagger) && (u.delay = j + u.stagger.call(t, e, A)), u.drag && (u.duration = parseFloat(L) || (/^(callout|transition)/.test(y) ? 1e3 : x), u.duration = Math.max(u.duration * (u.backwards ? 1 - e / A : (e + 1) / A), .75 * u.duration, 200)), S.Redirects[y].call(t, t, u || {}, e, A, v, E.promise ? E : i)
                                }), e()
                            }
                            var B = "Velocity: First argument (" + y + ") was not a property map, a known action, or a registered redirect. Aborting.";
                            return E.promise ? E.rejecter(new Error(B)) : console.log(B), e()
                        }
                        D = "start"
                }
                var V = {
                ...
                p.each(v, function(e, t) {
                    b.isNode(t) && r(t, e)
                }), u = p.extend({}, S.defaults, _), u.loop = parseInt(u.loop, 10);
                var R = 2 * u.loop - 1;
                if (u.loop)
                    for (var M = 0; M < R; M++) {
                        var H = {
                        ...
                        M === R - 1 && (H.display = u.display, H.visibility = u.visibility, H.complete = u.complete), T(v, "reverse", H)
                    }
                return e()
            };
            ...
            return e.Velocity = S, e !== t && (e.fn.velocity = T, e.fn.velocity.defaults = S.defaults), p.each(["Down", "Up"], function(e, t) {
                S.Redirects["slide" + t] = function(e, n, r, o, a, s) {
                    ...
                    l.display === i && (l.display = "Down" === t ? "inline" === S.CSS.Values.getDisplayType(e) ? "inline-block" : "block" : "none"), l.begin = function() {
                        0 === r && u && u.call(a, a);
                        for (var n in d)
                            if (d.hasOwnProperty(n)) {
                                f[n] = e.style[n];
                                var i = C.getPropertyValue(e, n);
                                d[n] = "Down" === t ? [i, 0] : [0, i]
                            }
                ...
                S.Redirects["fade" + t] = function(e, n, r, o, a, s) {
                    ...
                    }, l.display === i && (l.display = "In" === t ? "auto" : "none"), S(this, c, l)
                }
            }), S
    ...
    var l = function() {
        ...
        return o(e, [{
            ...
            value: function() {
                ...
                (0, s.default)(".js-modal-thumb").on("click", function(e) {
...
$(document).ready(function(){
	...
	$(document).on('click', '.search_icon_hov', function(){
		...
		$(this).hide();
			...
			if ($('.input_search').val() == ""){
				$('.header-top .search-widget form').removeClass('form_search_100');
				if ($(window).width() <= 767){
