    ...
    {foreach from=$facets item="facet"}
      {if $facet.displayed}
        <section class="facet clearfix">
          <h1 class="h6 text-uppercase  facet-title hidden-sm-down">{$facet.label}</h1>
                        ...
                        {if $facet.multipleSelectionAllowed}
                          <span class="custom-checkbox">
                            ...
                            {if isset($filter.properties.color)}
                              <span class="color{if ($filter.properties.color=='#ffffff')} color_pick_white{/if}" style="background-color:{$filter.properties.color}"></span>
