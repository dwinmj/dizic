...
*}
    ...
    <li class="container-fluid video_item" id="video_item_{$id|intval}_{$id_lang|intval}_{$id_lang|intval}_{$id_lang|intval}">
		...
		<div class="row-fluid">
			<div class="pull-left move_handler_button">
				<div class="btn btn-default" style="margin-left: 15px"><i class="material-icons">flip_to_front</i> {l s='Move' mod='anproductvideos'}</div>
			</div>
