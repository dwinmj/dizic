    ...
    <div class='col-lg-12'>
                    ...
                    {if $field.lang === true}
                        <div class="translations tabbable" id="{$field.name|escape:'htmlall':'UTF-8'}">
                            <div class="translationsFields tab-content">
                                ...
                                <div class="translationsFields-{$field.name|escape:'htmlall':'UTF-8'}_{$language.id_lang|intval} tab-pane translation-label-{$language.iso_code|escape:'htmlall':'UTF-8'}">
                                    <div class='col-md-3 text-right'>
                                        <label for='{$field.name|escape:'htmlall':'UTF-8'}_{$language.id_lang|intval}'>{$field.label|escape:'htmlall':'UTF-8'}</label>
                                    </div>
                                    <div class='col-md-9'>
                                        <textarea class='autoload_rte form-control' id='{$field.name|escape:'htmlall':'UTF-8'}_{$language.id_lang|intval}' name='{$field.name|escape:'htmlall':'UTF-8'}_{$language.id_lang|intval}'>
        ...
        <div class='form-group'>
            <div class="translations tabbable" id="apnt_button_submit">
                <div class="translationsFields tab-content">
                    {foreach from=$languages item=language}
                    <div class="translationsFields-apnt_button_submit_{$language.id_lang|intval} tab-pane translation-label-{$language.iso_code|escape:'htmlall':'UTF-8'}">
