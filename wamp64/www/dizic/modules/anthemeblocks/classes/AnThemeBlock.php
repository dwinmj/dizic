...
class AnThemeBlock extends ObjectModel
{
    ...
    public function getContent($param = array())
    {
        ...
        Context::getContext()->smarty->assign('an_staticblock', $this);
    ...
    public function getProducts()
    {
        ...
        $prefix = 'additional_field_'.basename($this->template, '.tpl').'_';
    ...
    public function getByNew()
    {
        ...
        $sql->limit($this->limit, $page_number * $nb_products);
    ...
    public function getByBestsellers()
    {
        ...
        if ($final_order_by != 'price') {
            $sql .= '
                    ...
                    LIMIT ' . (int) ($page_number * $nb_products) . ', ' . (int) $this->limit;
        }
