...
class Anscrolltop extends Module
{
    ...
    public function hookBackOfficeHeader()
    {
        if (in_array($this->name, array(Tools::getValue('module_name'), Tools::getValue('configure')))) {
            $this->context->controller->addCSS("//code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css");
    ...
    public function hookHeader()
    {
        if (version_compare(_PS_VERSION_, "1.7.0.0", "<")) {
            ...
            $this->context->controller->registerStylesheet("modules-scrolltop-fe1", "//code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css", array('priority' => 1, 'server' => 'remote'));
